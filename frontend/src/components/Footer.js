      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-300 max-w-md">
              The premier platform for trading on opinions, events, and predictions. 
              Turn your insights into profits and participate in the marketplace of ideas.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/my-trades" className="text-base text-gray-400 hover:text-white">
                  Your Trades
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <p className="text-base text-gray-400 text-center">
            &copy; {currentYear} OpinionTrade. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
